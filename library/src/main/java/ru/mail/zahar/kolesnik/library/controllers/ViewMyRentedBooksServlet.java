...
@WebServlet(name = "view_my_rented_books", urlPatterns = "/view_my_rented_books.cab")
public class ViewMyRentedBooksServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        Library library = new Library();
        List<Book> foundedBooks = null;
        try {
            foundedBooks = library.getIssuedBooksByClient(req.getSession().getAttribute("login").toString());
        ...
        req.getRequestDispatcher("/WEB-INF/pages/view_my_rented_books.jsp").forward(req, resp);
    }
}
