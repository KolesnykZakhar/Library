...
@WebServlet(name = "select_client_to_issue", urlPatterns = "/select_client_to_issue.cab")
public class SelectClientToIssueServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if(req.getParameter("clientName").trim().equals("") && req.getParameter("clientSurname").trim().equals("") &&
            ...
            req.getRequestDispatcher("/WEB-INF/pages/select_client_to_issue.jsp").forward(req, resp);
            return;
        }
        ...
        req.getRequestDispatcher("/WEB-INF/pages/choose_from_founded_client.jsp").forward(req, resp);
    }
    @Override
