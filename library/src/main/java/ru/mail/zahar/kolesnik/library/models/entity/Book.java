...
public class Book {
    ...
    public Book(int idBook, int isbn, String bookName, String category, String description, String authorName, String authorPatronymic,
                String authorSurname, Timestamp issuedDate, Timestamp returnedDate, Client issued) {
        this.idBook = idBook;
        this.isbn = isbn;
    ...
    public Client getIssued() {
        return issued;
    }

    public void setIssued(Client issued) {
        this.issued = issued;
    }
