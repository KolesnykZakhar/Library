...
@WebServlet(name = "search_book", urlPatterns = "/search_book.cab")
public class SearchBookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        if (req.getParameter("authorName").trim().equals("") && req.getParameter("authorPatronymic").trim().equals("") &&
            ...
            req.getRequestDispatcher("/WEB-INF/pages/search_book.jsp").forward(req, resp);
            return;
        }
        ...
        req.getRequestDispatcher("/WEB-INF/pages/founded_book.jsp").forward(req, resp);
    }
    @Override
